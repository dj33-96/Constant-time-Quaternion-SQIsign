...
// Namespacing symbols exported from bkz.c:
#undef ibz_vec_2x4_mul
#undef quat_bkz_lagrange_reduction_gram
#undef quat_bkz_matrix_init
#undef quat_bkz_matrix_finalize
#undef quat_bkz_matrix_set
#undef quat_bkz_size_reduce
#undef quat_bkz_update_after_lagrange
#undef quat_bkz_update_matrix
#undef quat_lattice_bkz


#define ibz_vec_2x4_mul                                 SQISIGN_NAMESPACE(ibz_vec_2x4_mul)
#define quat_bkz_lagrange_reduction_gram                SQISIGN_NAMESPACE(quat_bkz_lagrange_reduction_gram)
#define quat_bkz_matrix_init                            SQISIGN_NAMESPACE(quat_bkz_matrix_init)
#define quat_bkz_matrix_finalize                        SQISIGN_NAMESPACE(quat_bkz_matrix_finalize)
#define quat_bkz_matrix_set                             SQISIGN_NAMESPACE(quat_bkz_matrix_set)
#define quat_bkz_size_reduce                            SQISIGN_NAMESPACE(quat_bkz_size_reduce)
#define quat_bkz_update_after_lagrange                  SQISIGN_NAMESPACE(quat_bkz_update_after_lagrange)
#define quat_bkz_update_matrix                          SQISIGN_NAMESPACE(quat_bkz_update_matrix)
#define quat_lattice_bkz                                SQISIGN_NAMESPACE(quat_lattice_bkz)
...
// Namespacing symbols exported from ct_helpers.c:
#undef ibq_mat_4x4_equal_inverted
#undef ibq_round
#undef ibz_mat_4x4_equal_inverted
#undef ibz_vec_4_bilinear
#undef quat_alg_norm_ibz
#undef quat_lattice_ideal_norm
#undef quat_test_helper_ibq_equal_i
#undef quat_test_helper_ibq_set_i
#undef quat_test_helper_ibz_equal_i
#undef quat_test_helper_ibz_mat_2x2_set
#undef quat_test_helper_ibz_vec_4_equal
#undef quat_test_helper_is_reduced


#define ibq_mat_4x4_equal_inverted                      SQISIGN_NAMESPACE(ibq_mat_4x4_equal_inverted)
#define ibq_round                                       SQISIGN_NAMESPACE(ibq_round)
#define ibz_mat_4x4_equal_inverted                      SQISIGN_NAMESPACE(ibz_mat_4x4_equal_inverted)
#define ibz_vec_4_bilinear                              SQISIGN_NAMESPACE(ibz_vec_4_bilinear)
#define quat_alg_norm_ibz                               SQISIGN_NAMESPACE(quat_alg_norm_ibz)
#define quat_lattice_ideal_norm                         SQISIGN_NAMESPACE(quat_lattice_ideal_norm)
#define quat_test_helper_ibq_equal_i                    SQISIGN_NAMESPACE(quat_test_helper_ibq_equal_i)
#define quat_test_helper_ibq_set_i                      SQISIGN_NAMESPACE(quat_test_helper_ibq_set_i)
#define quat_test_helper_ibz_equal_i                    SQISIGN_NAMESPACE(quat_test_helper_ibz_equal_i)
#define quat_test_helper_ibz_mat_2x2_set                SQISIGN_NAMESPACE(quat_test_helper_ibz_mat_2x2_set)
#define quat_test_helper_ibz_vec_4_equal                SQISIGN_NAMESPACE(quat_test_helper_ibz_vec_4_equal)
#define quat_test_helper_is_reduced                     SQISIGN_NAMESPACE(quat_test_helper_is_reduced)
...
#define ibz_xor                                         SQISIGN_NAMESPACE_GENERIC(ibz_xor)
#define ibz_and                                         SQISIGN_NAMESPACE_GENERIC(ibz_and)
#define ibz_sgn                                         SQISIGN_NAMESPACE_GENERIC(ibz_sgn)
#define ibz_conditional_assign                          SQISIGN_NAMESPACE_GENERIC(ibz_conditional_assign)
#define ibz_conditional_swap                            SQISIGN_NAMESPACE_GENERIC(ibz_conditional_swap)

// Namespacing symbols exported from integers.c:
#undef ibz_cornacchia_prime
#undef ibz_generate_random_prime
#undef ibz_constant_halfgcd
#undef ibz_min_2
#undef ibz_max_2
#undef ibz_ct_cmov
...
#define ibz_constant_halfgcd                            SQISIGN_NAMESPACE_GENERIC(ibz_constant_halfgcd )
#define ibz_min_2                                       SQISIGN_NAMESPACE_GENERIC(ibz_min_2)
#define ibz_max_2                                       SQISIGN_NAMESPACE_GENERIC(ibz_max_2)
#define ibz_ct_cmov                                     SQISIGN_NAMESPACE_GENERIC(ibz_ct_mov)
...
#undef ibq_is_one
#undef ibq_is_zero
#undef ibq_mat_2x2_finalize
#undef ibq_mat_2x2_init
#undef ibq_mat_2x2_print
...
#define ibq_denom                                       SQISIGN_NAMESPACE_GENERIC(ibq_denom)
#define ibq_div                                         SQISIGN_NAMESPACE_GENERIC(ibq_div)
...
#define ibq_mat_2x2_finalize                            SQISIGN_NAMESPACE_GENERIC(ibq_mat_2x2_finalize)
#define ibq_mat_2x2_init                                SQISIGN_NAMESPACE_GENERIC(ibq_mat_2x2_init)
#define ibq_mat_2x2_print                               SQISIGN_NAMESPACE_GENERIC(ibq_mat_2x2_print)
...
#define ibq_num                                         SQISIGN_NAMESPACE_GENERIC(ibq_num)
...
// Namespacing symbols exported from test_bkz.c:
#undef quat_bkz_matrix_equal
#undef quat_test_bkz

#define quat_bkz_matrix_equal                           SQISIGN_NAMESPACE(quat_bkz_matrix_equal)
#define quat_test_bkz                                   SQISIGN_NAMESPACE(quat_test_bkz)
