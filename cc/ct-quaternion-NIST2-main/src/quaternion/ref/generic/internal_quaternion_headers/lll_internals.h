...
void ibq_mat_2x2_init(ibq_mat_2x2_t *mat);
void ibq_mat_2x2_finalize(ibq_mat_2x2_t *mat);

void ibq_vec_4_init(ibq_vec_4_t *vec);
void ibq_vec_4_finalize(ibq_vec_4_t *vec);

void ibq_mat_4x4_print(const ibq_mat_4x4_t *mat);
void ibq_mat_2x2_print(const ibq_mat_2x2_t *mat);
...
/** @brief Numerator
 */
void ibq_num(ibz_t *n, const ibq_t *q);

/** @brief Denominator
 */
void ibq_denom(ibz_t *d, const ibq_t *q);
