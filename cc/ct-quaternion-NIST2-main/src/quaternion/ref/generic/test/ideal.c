...
quat_test_lideal_create_principal(void)
{
    ...
    res |= ibz_cmp_int32(&I.lattice.basis[0][0], 1);
    res |= ibz_cmp_int32(&I.lattice.basis[1][0], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[2][0], 252142);
    res |= ibz_cmp_int32(&I.lattice.basis[3][0], 914413);

    res |= ibz_cmp_int32(&I.lattice.basis[0][1], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[1][1], 1);
    res |= ibz_cmp_int32(&I.lattice.basis[2][1], 246165);
    res |= ibz_cmp_int32(&I.lattice.basis[3][1], 252142);

    res |= ibz_cmp_int32(&I.lattice.basis[0][2], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[1][2], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[2][2], 1160578);
    res |= ibz_cmp_int32(&I.lattice.basis[3][2], 0);

    res |= ibz_cmp_int32(&I.lattice.basis[0][3], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[1][3], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[2][3], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[3][3], 1160578);
...
quat_test_lideal_create_from_primitive(void)
{
    ...
    res |= ibz_cmp_int32(&I.lattice.basis[0][0], 1);
    res |= ibz_cmp_int32(&I.lattice.basis[1][0], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[2][0], 50);
    res |= ibz_cmp_int32(&I.lattice.basis[3][0], 37);

    res |= ibz_cmp_int32(&I.lattice.basis[0][1], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[1][1], 1);
    res |= ibz_cmp_int32(&I.lattice.basis[2][1], 25);
    res |= ibz_cmp_int32(&I.lattice.basis[3][1], 50);

    res |= ibz_cmp_int32(&I.lattice.basis[0][2], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[1][2], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[2][2], 62);
    res |= ibz_cmp_int32(&I.lattice.basis[3][2], 0);

    res |= ibz_cmp_int32(&I.lattice.basis[0][3], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[1][3], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[2][3], 0);
    res |= ibz_cmp_int32(&I.lattice.basis[3][3], 62);
