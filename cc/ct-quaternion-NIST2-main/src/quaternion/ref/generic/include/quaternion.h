...
int quat_lideal_generator_old(quat_alg_elem_t *gen, const quat_left_ideal_t *lideal, const quat_alg_t *alg);
/** @}
 */
...
int quat_old_represent_integer(quat_alg_elem_t *gamma,
                           const ibz_t *n_gamma,
                           int non_diag,
                           const quat_represent_integer_params_t *params);

int quat_ct_represent_integer(quat_alg_elem_t *gamma,
                              const ibz_t *n_gamma,
                              int non_diag,
                              const quat_represent_integer_params_t *params);

int represent_integerold(quat_alg_elem_t *gamma, ibz_t *n_gamma, const quat_alg_t *Bpoo);

int quat_ct_represent_integerwithq(quat_alg_elem_t *gamma,
                                   const ibz_t *n_gamma,
                                   int non_diag,
                                   const quat_represent_integer_params_t *params);
